...
namespace UnityEngine.Perception.Randomization.Randomizers.SampleRandomizers
{
    ...
    /// </summary>
    [Serializable]
    [AddRandomizerMenu("Perception/Foreground Rotation Randomizer")]
    public class ForegroundRotationRandomizer : Randomizer
    {
        /// <summary>
        ...
        {
            var tags = tagManager.Query<ForegroundRotationRandomizerTag>();
